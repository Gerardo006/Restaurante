...
path('buscar-recetas/', menus_views.buscar_recetas, name='buscar_recetas'),  # Búsqueda de recetas
    path('receta/<int:receta_id>/', menus_views.detalle_receta, name='detalle_receta'),  # Detalles de receta
]
